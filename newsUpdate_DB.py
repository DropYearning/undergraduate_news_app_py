...
# 在表news_log中写入更新记录
SQL_INSERT_Log = "INSERT INTO news_log (updatetime, usedtime, all_count, car_count , digit_count, demostic_count, edu_count, entertainment_count, estate_count, finance_count, game_count, international_count, internet_count, military_count,  society_count, sport_count ,tech_count) VALUES ( '%s', '%s', '%d',  '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d')" % (updateTime, usedTime, newsCountAll, countDict['汽车'], countDict['数码'], countDict['国内'], countDict['教育'], countDict['娱乐'], countDict['房地产'], countDict['财经'], countDict['游戏'], countDict['国际'], countDict['互联网'], countDict['军事'], countDict['社会'], countDict['体育'], countDict['科技'])
try:
